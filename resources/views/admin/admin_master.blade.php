...
<head>
   ...
   <link href="{{asset('public/admin_assets/bootstrap/css/bootstrap-fileupload.css')}}" rel="stylesheet" />
   ...
   <link href="{{asset('public/admin_assets/fullcalendar/fullcalendar/bootstrap-fullcalendar.css')}}" rel="stylesheet" />
   <link href="{{asset('public/admin_assets/jquery-easy-pie-chart/jquery.easy-pie-chart.css')}}" rel="stylesheet" type="text/css" media="screen"/>
       ...
       <div class="navbar-inner">
           <div class="container-fluid">
               ...
               <a class="brand" href="index.html">
                   <img src="{{URL::to('public/admin_assets/img/logo.png')}}" alt="Metro Lab" />
               </a>
               <!-- END LOGO -->
                   ...
                   <ul class="nav top-menu">
                       ...
                       <li class="dropdown" id="header_inbox_bar">
                           ...
                           <ul class="dropdown-menu extended inbox">
                               ...
                               <li>
                                   <a href="#">
                                       <span class="photo"><img src="{{URL::to('public/admin_assets/img/avatar-mini.png')}}" alt="avatar" /></span>
									<span class="subject">
               ...
               <div class="top-nav ">
                   <ul class="nav pull-right top-menu" >
                       ...
                       <li class="dropdown">
                           <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                               <img src="{{URL::to('public/admin_assets/img/avatar1_small.jpg')}}" alt="">
         ...
         <!-- BEGIN SIDEBAR MENU -->
          <ul class="sidebar-menu">
              ...
              <li class="sub-menu">
                  ...
                  <ul class="sub">
                      <li><a class="" href="{{URL::to('add_category')}}">Add Category</a></li>
                      <li><a class="" href="{{URL::to('manage_category')}}">Manage Category</a></li>
              ...
              <li class="sub-menu">
                  ...
                  <ul class="sub">
                      <li><a class="" href="{{URL::to('add_brand')}}">Add Brand</a></li>
                      <li><a class="" href="{{URL::to('manage_brand')}}">Manage Brand</a></li>
              ...
              <li class="sub-menu">
                  ...
                  <ul class="sub">
                      <li><a class="" href="{{URL::to('add_product')}}">Add Product</a></li>
                      <li><a class="" href="{{URL::to('manage_product')}}">Manage Product</a></li>
              ...
              <li class="sub-menu">
                  ...
                  <ul class="sub">
                      <li><a class="" href="{{URL::to('manage_order')}}">Manage Order</a></li>
...
@yield('admin_content')
   ...
   <script type="text/javascript" src="{{asset('public/admin_assets/jquery-slimscroll/jquery-ui-1.9.2.custom.min.js')}}"></script>
   <script type="text/javascript" src="{{asset('public/admin_assets/jquery-slimscroll/jquery.slimscroll.min.js')}}"></script>
   <script src="{{asset('public/admin_assets/fullcalendar/fullcalendar/fullcalendar.min.js')}}"></script>
   ...
   <script src="{{asset('public/admin_assets/jquery-easy-pie-chart/jquery.easy-pie-chart.public/admin_assets/js')}}" type="text/javascript"></script>
   <script src="{{asset('public/admin_assets/js/jquery.sparkline.js')}}" type="text/javascript"></script>
   <script src="{{asset('public/admin_assets/chart-master/Chart.js')}}"></script>
   ...
   <script src="{{asset('public/admin_assets/js/home-chartjs.js')}}"></script>
