            ...
            <div class="column col-xs-12 col-sm-3" id="left_column">
             ...
             <!--    <div class="col-left-slide left-module">
                 <ul class="owl-carousel owl-style2" data-loop="true" data-nav = "false" data-margin = "30" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-items="1" data-autoplay="true">
                     <li><a href="#"><img src="{{URL::to('assets/data/slide-left.jpg')}}" alt="slide-left"></a></li>
                     <li><a href="#"><img src="{{URL::to('assets/data/slide-left2.jpg')}}" alt="slide-left"></a></li>
                     <li><a href="#"><img src="{{URL::to('assets/data/slide-left3.png')}}" alt="slide-left"></a></li>
                 </ul>
            ...
            <div class="center_column col-xs-12 col-sm-9" id="center_column">
                ...
                <!-- <div class="category-slider">
                    <ul class="owl-carousel owl-style2" data-dots="false" data-loop="true" data-nav = "true" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-items="1">
                        <li>
                            <img src="{{URL::to('assets/data/category-slide.jpg')}}" alt="category-slider">
                        </li>
                        <li>
                            <img src="{{URL::to('assets/data/slide-cart2.jpg" alt="category-slider')}}">
                        </li>
                    </ul>
                </div> -->
                <!-- ./category-slider -->
                ...
                <div class="subcategories">
                    <ul>
                        <li class="current-categorie">
                            <a href="#">{{$cat_info[0]->category_name}}</a>
                        </li>
                        <li>
                            <a href="#">Tops</a>
                        </li>
                ...
                <div id="view-product-list" class="view-product-list">
                    <h2 class="page-heading">
                        <span class="page-heading-title">{{$cat_info[0]->category_name}}</span>
                    </h2>
                   ...
                   @foreach($cat_info as $category_info)
                        <li class="col-sx-12 col-sm-4">
                            <div class="product-container">
                                <div class="left-block">
                                    <a href="{{URL::to('product/'.$category_info->product_id)}}">
                                        <img class="img-responsive" alt="product" style="height: 250px;width: 250px" src="{{URL::to($category_info->image_option)}}" />
                                    </a>
                                    ...
                                    <div class="add-to-cart">
                                        <a title="Add to Cart" href="{{URL::to('add_to_cart/'.$category_info->product_id)}}">Add to Cart</a>
                                    </div>
                                </div>
                                <div class="right-block">
                                    <h5 class="product-name"><a href="{{URL::to('product/'.$category_info->product_id)}}">{{$category_info->product_name}}</a></h5>
                                    ...
                                    <div class="content_price">
                                        <span class="price product-price">BDT {{$category_info->product_new_price}}</span>
                                        <span class="price old-price">BDT {{$category_info->product_old_price}}</span>
                                    </div>
                                    <div class="info-orther">
                                        <p>Item Code: #453217907</p>
                                        <p class="availability">Availability: <span>{{$category_info->product_stock}}</span></p>
                                        <div class="product-desc">
                                            {{$category_info->product_short_description}}
                                        </div>
                                    </div>
                                </div>
                            </div>
